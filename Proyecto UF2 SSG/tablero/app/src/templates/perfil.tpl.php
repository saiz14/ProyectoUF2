  ...
  <head>
	...
	<body>
		...
		<div class="right_col"> <?php
			...
			<h2 class="name"><?php echo $row[$key]['name'] ?></h2><br>
			<h3 class="location">Id: <?php echo $row[$key]['id'] ?></h3>
			<ul class="">
				<li class="work">Apellido: <?php echo $row[$key]['subname'] ?></li><br><br>
				<li class="website">Password hash: <?php echo $row[$key]['password'] ?></li><br>
				<li class="mail">Email: <?php echo $row[$key]['email'] ?></li><br><br>
				<li class="phone">Rol: <?php echo $row[$key]['role'] ?></li><br>
